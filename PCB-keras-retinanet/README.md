#This github is follow from:https://github.com/fizyr/keras-retinanet , thank you for the author.
#The difference is I train the model in the PCB dataset and add the detect vedio part in example/PCB_video.py
